...
resource "aws_ecs_service" "demoapp_main" {
  ...
  network_configuration {
    ...
    subnets = [
      data.aws_subnet.ecs-fargate-private-subnet-for-service-1a.id,
      data.aws_subnet.ecs-fargate-private-subnet-for-service-1b.id,
      data.aws_subnet.ecs-fargate-private-subnet-for-service-1c.id
    ]
